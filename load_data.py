import requests  # voltamos para o requests
import random 
import time
...
def executar_teste_carga():
    ...
    print(f"🚀 Iniciando Teste de Carga (Requests + Auth)")
    ...
    for i in range(1, QTD_REQUISICOES + 1):
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                print(f"#{i} [ID {dados['id']}] {payload['tipo_combustivel']} R$ {payload['preco_por_litro']} - {status}")
                sucessos += 1
            else:
